      ...
      <div className="flex-1 flex items-center justify-center p-6 md:p-8">
        <div className="max-w-5xl w-full grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <h1 className="text-6xl font-black bg-gradient-to-r from-sky-300 via-sky-500 to-blue-700 bg-clip-text text-transparent mb-6">
              XP TRACKER
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                ...
                className="bg-gradient-to-r from-sky-300 to-blue-600 text-black px-8 py-4 rounded-2xl font-bold hover:scale-105 transition-all flex items-center justify-center gap-2"
              >
          ...
          <div className="bg-zinc-950 border border-sky-500/20 rounded-3xl p-8 shadow-[0_0_60px_rgba(56,189,248,0.18)]">
            <h2 className="text-2xl font-black text-sky-300 mb-6">
            ...
            <div className="space-y-4 text-zinc-300">
              {trackedFeatures.map(({ label, icon: Icon }) => (
                <p key={label} className="flex items-center gap-3">
                  <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl border border-sky-500/20 bg-sky-400/10 text-sky-300">
