...
export function ReferralInviteAction({
  ...
  return (
    <div className="fixed bottom-[13.75rem] right-5 z-30">
      {open && (
        <>
          <button
            type="button"
      ...
      <button
        ...
        className="relative z-10 flex h-12 w-12 items-center justify-center rounded-full border border-emerald-500/40 bg-emerald-500/15 text-emerald-200 shadow-[0_0_30px_rgba(16,185,129,0.2)] transition-all hover:border-emerald-300 hover:bg-emerald-400 hover:text-black"
        aria-expanded={open}
