...
function naturalCriptaOnePlayers(level: number, players: 4 | 5, xp: number): FarmActivity {
  return {
...
const FARM_ACTIVITIES: FarmActivity[] = [
  ...
  naturalCriptaOnePlayers(20, 4, 33452),
  naturalCriptaOnePlayers(21, 4, 36610),
  naturalCriptaOnePlayers(22, 4, 39989),
  naturalCriptaOnePlayers(23, 4, 43604),
  naturalCriptaOnePlayers(24, 4, 47472),
  naturalCriptaOnePlayers(25, 4, 51611),
  naturalCriptaOnePlayers(26, 4, 56040),
  naturalCriptaOnePlayers(27, 4, 60779),
  naturalCriptaOnePlayers(28, 4, 65850),
  naturalCriptaOnePlayers(29, 4, 71275),
  naturalCriptaOnePlayers(30, 4, 77080),
  naturalCriptaOnePlayers(31, 4, 83292),
  naturalCriptaOnePlayers(32, 4, 89900),
  naturalCriptaOnePlayers(33, 4, 96900),
  naturalCriptaOnePlayers(34, 4, 104400),
  naturalCriptaOnePlayers(35, 4, 112400),
  naturalCriptaOnePlayers(20, 5, 33452),
  naturalCriptaOnePlayers(21, 5, 36610),
  naturalCriptaOnePlayers(22, 5, 39989),
  naturalCriptaOnePlayers(23, 5, 43604),
  naturalCriptaOnePlayers(24, 5, 47472),
  naturalCriptaOnePlayers(25, 5, 51611),
  naturalCriptaOnePlayers(26, 5, 56040),
  naturalCriptaOnePlayers(27, 5, 60779),
  naturalCriptaOnePlayers(28, 5, 65850),
  naturalCriptaOnePlayers(29, 5, 71275),
  naturalCriptaOnePlayers(30, 5, 77080),
  naturalCriptaOnePlayers(31, 5, 83292),
  naturalCriptaOnePlayers(32, 5, 89900),
  naturalCriptaOnePlayers(33, 5, 96900),
  naturalCriptaOnePlayers(34, 5, 104400),
  naturalCriptaOnePlayers(35, 5, 112400),
  {
    id: "cripta-n1-30-4",
    category: "Cripta",
  ...
  },
  {
    ...
    detail: "4 jogadores",
    players: 4,
    xpByLevel: xpForExactLevel(33, 67990),
  },
  {
    id: "cripta-n1-16-4",
    category: "Cripta",
  ...
  {
    id: "fenda-solar-magia",
    category: "Masmorra",
    name: "Fenda Solar - Guardião Solar da Magia",
    detail: "1 jogador",
    players: 1,
    xp: 852,
  },
  {
    id: "fenda-solar-forca",
    category: "Masmorra",
    name: "Fenda Solar - Guardião Solar da Força",
    detail: "1 jogador",
    players: 1,
    xp: 864,
  },
  {
    id: "fenda-solar-combate",
    category: "Masmorra",
    name: "Fenda Solar - Guardião Solar do Combate",
    detail: "1 jogador",
    players: 1,
    xp: 876,
  },
...
const QUICK_RUN_ORDER: Partial<Record<QuickRunTab, Partial<Record<number, string[]>>>> = {
  "cripta-1": {
    ...
    5: [
      "cripta-n1-natural-20-5",
      "cripta-n1-natural-21-5",
      "cripta-n1-natural-22-5",
      "cripta-n1-natural-23-5",
      "cripta-n1-natural-24-5",
      "cripta-n1-natural-25-5",
      "cripta-n1-natural-26-5",
      "cripta-n1-natural-27-5",
      "cripta-n1-natural-28-5",
      "cripta-n1-natural-29-5",
      "cripta-n1-natural-30-5",
      "cripta-n1-natural-31-5",
      "cripta-n1-natural-32-5",
      "cripta-n1-natural-33-5",
      "cripta-n1-natural-34-5",
      "cripta-n1-natural-35-5",
      "cripta-n1-25-5",
      "cripta-n1-26-5",
      "cripta-n1-27-5",
      "cripta-n1-28-5",
...
function getDoubleXpMultiplier(
  activity: Pick<ResolvedFarmActivity, "category">,
  doubleXpMode: DoubleXpMode
) {
...
export function FarmRunsCard({
  ...
  const selectedActivityHasDoubleXp =
    ...
    getDoubleXpMultiplier(selectedActivity, doubleXpMode) > 1;
  const baseXpTotal = (selectedActivity?.xp ?? 0) * runs;
  const xpTotal = selectedActivityXP * runs;
  ...
  const recommendedRuns = useMemo(() => {
    ...
    return [...planActivities]
      .sort((a, b) => {
        ...
        const runsA = Math.ceil(currentXP / xpA);
        const runsB = Math.ceil(currentXP / xpB);
  ...
  const farmPlan = useMemo(() => {
    ...
    if (planMode === "fewest-runs") {
      return buildSingleActivityPlan(currentXP, effectivePlanActivities);
    }
