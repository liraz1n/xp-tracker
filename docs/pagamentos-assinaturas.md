...
Build 1.4.4 mantém a base comercial do XP Tracker, adiciona feedback visual ao registro rápido de runs, reforça a compatibilidade de carregamento após refresh e preserva a base atualizada da Cripta 3.
